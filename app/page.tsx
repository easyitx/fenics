        ...
        <div className="min-h-screen">
            <div className="boxes__section">
                <div className="boxes__section__heading">
                    ...
                    <div className="description">Вы пополнили баланс на <span>$ 200</span></div>
                </div>
                    ...
                    {new Array(6).fill(0).map((_, i) => (
                        <div key={i} className="boxesListItem">
                            <div className="boxesListItem__case">
                                <img className="caseImage" src="/cases/1.png" alt='case'/>
                            </div>
            ...
            <div className="boxes__section">
                ...
                <div className="boxes__section__list">
                    {new Array(10).fill(0).map((_, i) => (
                        <div key={i} className="boxesListItem">
                            <div className="boxesListItem__case">
                                <img className="caseImage" src="https://api.csfade.gg/boxes/76cb2310-1044-4e93-8cbe-23a9b756949b.webp" alt='case'/>
                            </div>
                            <div className="boxesListItem__footer">
