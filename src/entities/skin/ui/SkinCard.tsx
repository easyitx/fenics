...
import { Skin } from "../model/types";

interface Props {
    skin?: Skin
}

export const SkinCard = (props: Props) => {
    const skin = {
        _id: "zx",
        marketName: "★ StatTrak™ Flip Knife | Case Hardened (Well-Worn)",
        weaponName: "Flip Knife",
        shortName: "Case Hardened",
        itemImage: "https://cdn.csgoskins..png",
        rarity: 'ancient',
